...
export default async function RecapPage({
  ...
  const AWARD_ORDER: AwardType[] = ['spieltagskoenig', 'eier_aus_stahl', 'unlucky_bastard', 'ergebnis_orakel', 'griff_ins_klo', 'betonmischer', 'on_fire', 'grosser_wurf', 'klingelingeling', 'torschuetzen_koenig', 'last_minute_tipper', 'storno_champ']

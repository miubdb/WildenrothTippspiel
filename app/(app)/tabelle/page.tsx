          ...
          return (
            ...
            >
              ...
              <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 ${
                isPromotion ? 'bg-green-600 text-white'
                : isPromotionPlayoff ? 'bg-green-200 text-green-800'
                : isDirect ? 'bg-red-500 text-white'
                : isPlayoff ? 'bg-orange-200 text-orange-700'
                : 'text-gray-400'
              }`}>
                {pos}
              </div>
